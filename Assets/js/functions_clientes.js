...
document.addEventListener('DOMContentLoaded',function(){
    ...
    function printDataClientes(dataArray){
        for (var r = 0; r < dataArray.length; r++) {
            ...
            cell_6.innerHTML = '<button class="btn btn-primary btn-sm m-0" title="Editar"><i class="gg-pen"></i></button>';
            ...
            cell_7.innerHTML = '<button class="btn btn-danger btn-sm m-0" title="Eliminar"><i class="gg-trash"></i></button>';
